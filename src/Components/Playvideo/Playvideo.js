  ...
  return (
    <div className='playvideo'>
        ...
        <div className='video-info'>
                    ...
                    <div>
                       <span> <img src={like} alt='like-img'></img> {apidata ?convert_value(apidata.statistics.likeCount)  : 144}</span> 
                      <span><img src={dislike} alt='dislike-img'></img> </span>
                      <span><img src={share} alt='share-img'></img> </span>
                      <span><img src={save} alt='save-img'></img> </span> 
                    </div>
        </div>
        ...
        <div className='publisher'>
                ...
                <img src={channeldata ? channeldata.snippet.thumbnails.default.url :""} alt='channel-img'></img>
                <div >
                ...
                <h2>{apidata ? convert_value(apidata.statistics.commentCount ): 200} comments</h2>
                {
                        ...
                        return(
                                <div key={index} className='user-comment'>
                                        ...
                                        <img src={item.snippet.topLevelComment.snippet.authorProfileImageUrl} className='profile' alt='auth-profile'></img>
                                        ...
                                        <div className='comment-icon'>
                                                <img src={like} alt='like-icon'></img><span>{item.snippet.topLevelComment.snippet.likeCount}</span>
                                                <img src={dislike} alt='dislike-icon'></img><span>200</span>
                                        </div>
